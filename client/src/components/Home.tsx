      ...
      <div className="bg-white rounded-lg shadow-2xl p-8 max-w-md w-full">
        ...
        <div className="space-y-4">
          <button
            ...
            disabled={isCreating}
            className="w-full bg-green-600 hover:bg-green-700 disabled:bg-grey-400 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-200"
          >
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white text-grey-500">or</span>
            </div>
          </div>
          ...
          <div className="space-y-2">
            <input
              ...
              className="w-full px-4 py-3 border border-grey-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
            />
            <button
              onClick={handleJoinGame}
              disabled={!joinCode.trim()}
              className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-grey-400 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-200"
            >
              Join game
            </button>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-grey-200">
          <h2 className="font-semibold text-grey-900 mb-2">How to play:</h2>
          <ol className="text-sm text-grey-600 space-y-1 list-decimal list-inside">
